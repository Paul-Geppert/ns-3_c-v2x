...
void
MacStatsCalculator::SetSlUeOutputFilename (std::string outputFilename)
{
  LteStatsCalculator::SetSlUeOutputFilename (outputFilename);
}

std::string
MacStatsCalculator::GetSlUeOutputFilename (void)
{
  return LteStatsCalculator::GetSlUeOutputFilename ();
}
...
void
MacStatsCalculator::SlUeScheduling (SlUeMacStatParameters params)
{
...
void
MacStatsCalculator::SlUeSchedulingCallback (Ptr<MacStatsCalculator> macStats, std::string path, SlUeMacStatParameters params)
